...
def remove(compressedfile, extract_path):
    '''Extract files
...
def main():
    ...
    if args.wishto == "compress":
        ...
        dict_compression_power = {
            ...
            4: "/ebook",
            5: "/screen"}
        level_of_compression = dict_compression_power[args.power_compression]

        os.system(args.gs_path +
                  " -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 " +
                  "-dPDFSETTINGS=" + level_of_compression +
                  " -dNOPAUSE -dQUIET -dBATCH -sOutputFile=" +
                  args.output_pdf + " " + args.input_pdf)
